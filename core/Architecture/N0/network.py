...
def Darknet(name=None):
    ...
    x = common.convolutional(x,      filters_shape=(3, 3, 64), name='init_conv2', downsample=True)
...
def YOLOv3(sizes):
    ...
    conv = common.convolutional(conv, (1, 1, 192), name='Mconv1')
    conv = common.convolutional(conv, (3, 3, 384), name='Mconv2')
    conv = common.convolutional(conv, (1, 1, 192), name='Mconv3')

    conv_mobj_branch = common.convolutional(conv, (3, 3, 384), name='Mbranch')
    conv_mbbox = common.convolutional(conv_mobj_branch, (1, 1, 384, 3*(NUM_CLASS + 5)), activate=False, bn=False, name='Mdetect')
