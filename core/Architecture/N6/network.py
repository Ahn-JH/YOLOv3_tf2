...
def Darknet(name=None):
    ...
    x = common.convolutional(inputs, filters_shape=(3, 3, 8 ), name='conv0')

    #  x = common.convolutional(x,      filters_shape=(1, 1, 16), name='ZOOM0_0')
    #  x = common.convolutional(x,      filters_shape=(5, 5, 32), name='ZOOM0_1')
    #  x = common.convolutional(x,      filters_shape=(1, 1, 16), name='ZOOM0_2')
    #  x = common.convolutional(x,      filters_shape=(3, 3, 16), name='conv1', downsample=True)
    #
    x = common.convolutional(x,      filters_shape=(1, 1, 32), name='ZOOM1_0')
    x = common.convolutional(x,      filters_shape=(5, 5, 64), name='ZOOM1_1')
    x = common.convolutional(x,      filters_shape=(1, 1, 32), name='ZOOM1_2')
    x = common.convolutional(x,      filters_shape=(3, 3, 32), name='conv2', downsample=True)

    x = common.Residual_block(x, 32, 1, name="Residual2")

    x = common.convolutional(x,      filters_shape=(1, 1, 64 ), name='ZOOM2_0')
    x = common.convolutional(x,      filters_shape=(5, 5, 128), name='ZOOM2_1')
    x = common.convolutional(x,      filters_shape=(1, 1, 64 ), name='ZOOM2_2')
    ...
    x = common.convolutional(x,      filters_shape=(1, 1, 128), name='ZOOM3_0')
    x = common.convolutional(x,      filters_shape=(5, 5, 256), name='ZOOM3_1')
    x = common.convolutional(x,      filters_shape=(1, 1, 128), name='ZOOM3_2')
    x = common.convolutional(x,      filters_shape=(3, 3, 128), name='conv4', downsample=True)
    x = common.Residual_block(x, 128, 4, name="Residual4")

    route_1 = x

    x = common.convolutional(x,      filters_shape=(1, 1, 256), name='ZOOM4_0')
    x = common.convolutional(x,      filters_shape=(5, 5, 512), name='ZOOM4_1')
    x = common.convolutional(x,      filters_shape=(1, 1, 256), name='ZOOM4_2')
    x = common.convolutional(x,      filters_shape=(3, 3, 256), downsample=True, name='conv5')

    route_0 = common.Residual_block(x, 256, 2, name="Residual5")
