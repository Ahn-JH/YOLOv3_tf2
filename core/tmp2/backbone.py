...
def darknet53(input_data, name=None):
    ...
    input_data = common.convolutional(input_data, filters_shape=(3, 3,  3,  16),  name='conv0')
    input_data = common.convolutional(input_data, filters_shape=(3, 3, 16,  32),  name='conv1', downsample=True)
    input_data = common.convolutional(input_data, filters_shape=(3, 3, 32,  64),  name='conv2', downsample=True)

    for i in range(1):
        input_data = common.residual_block(input_data, 64,  32, 64)

    input_data = common.convolutional(input_data, filters_shape=(3, 3, 64, 128),
                                       name='conv5', downsample=True)
